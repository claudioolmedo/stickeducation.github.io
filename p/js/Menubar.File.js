// Some menu items are not listed, please refer to the original Menubar.File.js file
// To make an option appear, enable it by uncommenting.
// options.add( option );
...
function MenubarFile( editor ) {
	...
	// options.add( option ); // Uncomment to list in menu
